! function (e) {
    ...
    r.prototype.init = function () {
        ...
        return new o(function (e) {
            s.oldAndroid || s.mQQBrowser || !navigator.userAgent ? n.e(2, function (t) {
                var n = [t(6)];
                (function (t) {
                    var n = new t,
                        r = a.getImageData(0, 0, i.width, i.height);
                    e(n.encode(r, 100 * u.quality))
                }).apply(null, n)
            }) : e(i.toDataURL("image/jpeg", u.quality))
        })
        ...
        return new r(e, t)
    }, window.lrz.version = "4.2.1", e.exports = window.lrz
}, function (e, t, n) {
    (function (t) {
        ! function (n) {
            function r(e, t) {
    ...
    (function () {
        ...
        function l(e, t, n) {
            for (var r, i, o, a, s, u = new DataView(e), c = {}, l = t; t + n > l;) 28 === u.getUint8(l) && 2 === u.getUint8(l + 1) && (a = u.getUint8(l + 2), a in P && (o = u.getInt16(l + 3), s = o + 5, i = P[a], r = f(u, l + 5, o), c.hasOwnProperty(i) ? c[i] instanceof Array ? c[i].push(r) : c[i] = [c[i], r] : c[i] = r)), l++;
            return c
        }
        ...
        function d(e, t, n, r, i) {
            var o, a, s, u = e.getUint16(n, !i),
                c = {};
            for (s = 0; u > s; s++) o = n + 12 * s + 2, a = r[e.getUint16(o, !i)], !a && p && console.log("Unknown tag: " + e.getUint16(o, !i)), c[a] = h(e, o, t, n, i);
            return c
        }

        function h(e, t, n, r, i) {
            var o, a, s, u, c, l, d = e.getUint16(t + 2, !i),
                h = e.getUint32(t + 4, !i),
            ...
            switch (d) {
                ...
                case 7:
                    ...
                    for (o = h > 4 ? g : t + 8, a = [], u = 0; h > u; u++) a[u] = e.getUint8(o + u);
                    return a;
                case 2:
                    return o = h > 4 ? g : t + 8, f(e, o, h - 1);
                case 3:
                    if (1 == h) return e.getUint16(t + 8, !i);
                    for (o = h > 2 ? g : t + 8, a = [], u = 0; h > u; u++) a[u] = e.getUint16(o + 2 * u, !i);
                    return a;
                case 4:
                    if (1 == h) return e.getUint32(t + 8, !i);
                    for (a = [], u = 0; h > u; u++) a[u] = e.getUint32(g + 4 * u, !i);
                    return a;
                case 5:
                    if (1 == h) return c = e.getUint32(g, !i), l = e.getUint32(g + 4, !i), s = new Number(c / l), s.numerator = c, s.denominator = l, s;
                    for (a = [], u = 0; h > u; u++) c = e.getUint32(g + 8 * u, !i), l = e.getUint32(g + 4 + 8 * u, !i), a[u] = new Number(c / l), a[u].numerator = c, a[u].denominator = l;
                    return a;
                case 9:
                    if (1 == h) return e.getInt32(t + 8, !i);
                    for (a = [], u = 0; h > u; u++) a[u] = e.getInt32(g + 4 * u, !i);
                    return a;
                case 10:
                    if (1 == h) return e.getInt32(g, !i) / e.getInt32(g + 4, !i);
                    for (a = [], u = 0; h > u; u++) a[u] = e.getInt32(g + 8 * u, !i) / e.getInt32(g + 4 + 8 * u, !i);
                    return a
            }
        }
        ...
        function g(e, t) {
            if ("Exif" != f(e, t, 4)) return p && console.log("Not valid EXIF data! " + f(e, t, 4)), !1;
            var n, r, i, o, a, s = t + 6;
            ...
            if (r = d(e, s, s + u, v, n), r.ExifIFDPointer) {
            ...
            if (r.GPSInfoIFDPointer) {
                a = d(e, s, s + r.GPSInfoIFDPointer, y, n);
                for (i in a) {
                    switch (i) {
                        case "GPSVersionID":
