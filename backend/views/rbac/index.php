...
<section class="content-header">
  <h1><?=$span?>列表<a href="<?= Url::toRoute(['menu/edit']) ?>" class="btn btn-primary" style="margin-left: 20px;"><i class="glyphicon glyphicon-plus-sign"></i><span>添加</span></a></h1>
  <ol class="breadcrumb">
...
<div class="row">
    <div class="box col-md-12">
        <div class="box-inner">
            ...
            <div class="box-content"  data-list="<?= Url::toRoute('menu/list') ?>" data-del="<?= Url::toRoute('news/del') ?>">
