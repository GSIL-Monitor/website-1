...
<section class="content-header">
    <h1><?=$span?>列表<a href="<?= Url::toRoute(['rbac/add-permission']) ?>" class="btn btn-primary" style="margin-left: 20px;"><i class="glyphicon glyphicon-plus-sign"></i><span>添加</span></a></h1>
    <ol class="breadcrumb">
            ...
            <div class="box-inner">
                ...
                <div class="box-create">
                    ...
                    $form = ActiveForm::begin([
                        'id' => 'list-form',
                        'action' => Url::toRoute('rbac/permission-list'),
                        'options' => ['class' => 'form-horizontal'],
                    ]);
                    ?>
                    <div class="form-group form-group-sm">
                        <label class="control-label col-md-1">权限名</label><div class="col-md-2"><input class="form-control" type="text" name="title"></div>
                ...
                <div class="box-content"  data-list="<?= Url::toRoute('rbac/permission-list') ?>" data-del="<?= Url::toRoute('news/del') ?>">
