        ...
        <div class="box-inner">
            ...
            <div class="box-create">
	                ...
	                $form = ActiveForm::begin([
	                     'id' => 'list-form',
                         'action' => Url::toRoute('banner/list'),
            ...
            <div class="box-content"  data-list="<?= Url::toRoute('banner/list') ?>" data-del="<?= Url::toRoute('banner/del') ?>">
