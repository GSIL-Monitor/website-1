...
<section class="content-header">
  <h1><?=$span?>列表<a href="<?= Url::toRoute(['join-us/edit']) ?>" class="btn btn-primary" style="margin-left: 20px;"><i class="glyphicon glyphicon-plus-sign"></i><span>添加</span></a></h1>
  <ol class="breadcrumb">
        ...
        <div class="box-inner">
            ...
            <div class="box-create">
	                ...
	                $form = ActiveForm::begin([
	                     'id' => 'list-form',
                         'action' => Url::toRoute('join-us/list'),
            ...
            <div class="box-content"  data-list="<?= Url::toRoute('join-us/list') ?>" data-del="<?= Url::toRoute('join-us/del') ?>">
