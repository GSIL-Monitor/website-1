...
$cate = ArrayHelper::map(\common\models\Category::getParent('case'),'cate_id','cate_title');
$span = $cate[$type];
$this->title = '案例列表-后台首页';
$this->params['breadcrumbs'][] = '首页banner列表';
?>
<!-- Content Header (Page header) -->
<section class="content-header">
  <h1><?=$span?>列表 <a href="<?= Url::toRoute(['case/edit','type'=>$type]) ?>" class="btn btn-primary" style="margin-left: 20px;"><i class="glyphicon glyphicon-plus-sign"></i><span>添加</span></a></h1>
  <ol class="breadcrumb">
        ...
        <div class="box-inner">
            ...
            <div class="box-create">
	                ...
	                $form = ActiveForm::begin([
	                     'id' => 'list-form',
                         'action' => Url::toRoute('case/list'),
                         'options' => ['class' => 'form-horizontal'],
	                ]);
	                ?>

	                <div class="form-group form-group-sm">
				        <label class="control-label col-md-1">标题</label><div class="col-md-2"><input class="form-control" type="text" name="title"></div>
            ...
            <div class="box-content"  data-list="<?= Url::toRoute('case/list') ?>" data-del="<?= Url::toRoute('case/del') ?>">
