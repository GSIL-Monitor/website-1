...
$this->title = '首页banner列表-后台首页';
$this->params['breadcrumbs'][] = '首页banner列表';
?>
<!-- Content Header (Page header) -->
<section class="content-header">
  <h1>首页banner列表<a href="<?= Url::toRoute(['indexbanner/edit']) ?>" class="btn btn-primary" style="margin-left: 20px;"><i class="glyphicon glyphicon-plus-sign"></i><span>添加</span></a></h1>
  <ol class="breadcrumb">
        ...
        <div class="box-inner">
            ...
            <div class="box-create">
	                ...
	                $form = ActiveForm::begin([
	                     'id' => 'list-form',
                         'action' => Url::toRoute('indexbanner/list'),
                         'options' => ['class' => 'form-horizontal'],
	                ]);
	                ?>

	                <div class="form-group form-group-sm">
				        <label class="control-label col-md-1">banner标题</label><div class="col-md-2"><input class="form-control" type="text" name="img_title"></div>			             				         
            ...
            <div class="box-content"  data-list="<?= Url::toRoute('indexbanner/list') ?>" data-del="<?= Url::toRoute('indexbanner/del') ?>">
