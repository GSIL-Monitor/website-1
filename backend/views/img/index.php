...
$this->title = '图文列表-后台首页';
$this->params['breadcrumbs'][] = '首页banner列表';
?>
<!-- Content Header (Page header) -->
<section class="content-header">
  <h1>图文列表 <a href="<?= Url::toRoute(['img/edit','type'=>$type]) ?>" class="btn btn-primary" style="margin-left: 20px;"><i class="glyphicon glyphicon-plus-sign"></i><span>添加</span></a></h1>
  <ol class="breadcrumb">
...
<div class="row">
    <div class="box col-md-12">
        <div class="box-inner">
            ...
            <div class="box-content"  data-list="<?= Url::toRoute('img/list') ?>" data-del="<?= Url::toRoute('img/del') ?>">
