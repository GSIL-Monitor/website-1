...
$this->params['bodyClass'] = 'fixed-sidebar full-height-layout gray-bg'
?>
    <div id="wrapper">
        <!--左侧导航开始-->
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <?php foreach (\backend\models\Menu::getParent() as $k => $v) { ?>
                        <li>
                            <a href="<?=(is_null($v->controller || is_null($v->function)?'#':Url::toRoute([$v->controller.'/'.$v->function])))?>"><i class="fa <?=$v->icon ? $v->icon : 'fa-envelope'?>"></i> <span class="nav-label"><?=$v->name?></span><span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <?=\backend\models\Menu::setSecond($v->id)?>
                            </ul>
                        </li>
                    <?php } ?>
            ...
            <div class="row border-bottom">
                <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
                    ...
                    <ul class="nav navbar-top-links navbar-right">
                        ...
                        <li class="hidden-xs">
                            <a href="index_v1.html" class="J_menuItem" data-index="0"><i
...
<?php
AppAsset::addScript($this, 'admin/scripts/hplus.js');
AppAsset::addScript($this, 'admin/scripts/contabs.js');
AppAsset::addScript($this, 'admin/scripts/plugins/pace/pace.min.js');
$js = <<<JS
