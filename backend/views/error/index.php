...
$this->title = '后台首页';
$this->params['breadcrumbs'][] = '错误日志列表';
?>
        ...
        <div class="box-inner">
            ...
            <div class="box-create">
	                ...
	                $form = ActiveForm::begin([
	                     'id' => 'list-form',
                         'action' => Url::toRoute(['error/list']),
                         'options' => ['class' => 'form-horizontal'],
	                ]);
	                ?>
			        <div class="form-group form-group-sm">
				        <label class="control-label col-md-1">标题</label><div class="col-md-2"><input class="form-control" type="text" name="message"></div>
                        <label class="control-label col-md-1">通知</label><div class="col-md-2"><?= Html::dropDownList("is_mail", 0, Yii::$app->params["enabled"],["prompt" => "全部", "class" => "form-control"]) ?></div>
            ...
            <div class="box-content"  data-list="<?= Url::toRoute(['error/list']) ?>" data-del="<?= Url::toRoute('error/del') ?>">
